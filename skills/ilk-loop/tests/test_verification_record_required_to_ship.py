"""PLACEHOLDER — step 0 of `a-verification-subplan-cannot-ship-without-its-record` replaces this file.

What step 0 must pin: a batch_verification sub-plan cannot ship while its record is absent.
