"""PLACEHOLDER — step 0 of `a-gate-first-step-runs-before-the-agent` replaces this file.

What step 0 must pin: a green gate-first step invokes NO agent; a red one invokes it exactly once.
